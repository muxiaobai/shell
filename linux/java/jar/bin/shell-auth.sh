...
nohup /opt/jar/jdk1.8.0_201/bin/java ${JAVA_OPTIONS}  -jar ${appId}.jar  ${eurekaip} ${datasource}  ${datasourceusername} ${datasourcepwd} ${rabbitmq} ${redis}  ${vsburl} > ${appId}.log  2>&1 &
