...
# curl修改密码
curl -H "Content-Type:application/json" -XPOST -u my_admin:my_password 'http://192.168.120.83:9200/_xpack/security/user/elastic/_password' -d '{ "password" : "elasticsearch_2017@*))" }'
